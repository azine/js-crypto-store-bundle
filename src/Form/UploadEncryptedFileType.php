...
class UploadEncryptedFileType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('expiry', DateTimeType::class, array('widget' => 'single_text', 'attr' => array('input_format' => 'yyyy-mm-dd hh:mm', 'date_format' => 'yyyy-mm-dd hh:mm', 'placeholder' => 'yyyy-mm-dd hh:mm'), 'label' => '_az.jscrypto.upload.expiry.label', 'required' => false));
